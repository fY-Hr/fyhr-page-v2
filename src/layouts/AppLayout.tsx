...
export function AppLayout({ children } : { children: ReactNode }) {
  ...
  return (
    <div className="h-screen w-full overflow-x-hidden text-[#bac3dd] bg-[#012182]">
      <div className="sm:w-11/12 md:w-3/4 lg:w-1/2 mx-auto">
        ...
        <main className="h-full w-full flex flex-col overflow-y-auto overflow-x-hidden pt-24 px-8">
